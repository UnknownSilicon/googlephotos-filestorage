package com.unknownsilicon.gpfs.utility;
...
public class UpdateHandler {
	...
	private static final String GITHUB_RELEASE_URL = "https://api.github.com/repos/unknownsilicon/googlephotos-filestorage/releases/latest";
	...
	public boolean checkVersion() {
		...
		if (latestVersion == null) {
			...
			if (latestVersion.compareTo(version) > 0) {
				System.out.println("Your version is out of date, please visit https://github.com/unknownsilicon/googlephotos-filestorage/releases/latest to download the latest update.");
			} else {
